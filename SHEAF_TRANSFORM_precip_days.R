# TITLE:        SHEAF_TRANSFORM_precip_days.R
#
# AUTHOR:       Erich Seamon
#
...
# STAGE:        netcdf access
#
# COMMENTS:     This script downloads precip data from 2007 - 2012 nationwide and attempts to count the number
#               days that a county has above a certain level of precip
#
